...
class SocketIOManager {
  ...
  static const MethodChannel _channel =
      const MethodChannel('flutter_socket_io');
  ...
  SocketIOManager._internal() {
    _sockets = new Map();
    _channel
        .setMethodCallHandler(handler as Future<dynamic> Function(MethodCall)?);
  }
  ...
  SocketIO? createSocketIO(String domain, String namespace,
    ...
    if (socketIO == null) {
      ...
      socketIO = new SocketIO(_channel, domain, namespace,
